      ...
      <el-col :span="4" style="min-height: 100%; background-color: #324057;">
        <el-menu :default-active="defaultActive" style="min-height: 100%;" theme="dark" router>
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="addProject">新增项目</el-menu-item>
          </el-submenu>
          <el-submenu index="3">
            <template slot="title">
          ...
          <el-submenu index="4">
            <template slot="title">
              <i class="el-icon-star-on"></i>用例管理
            </template>
            <el-menu-item index="visitor">用例列表</el-menu-item>
            <el-menu-item index="visitor">新增用例</el-menu-item>
